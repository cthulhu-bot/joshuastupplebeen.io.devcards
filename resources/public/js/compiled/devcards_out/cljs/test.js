...
var args33245 = [];
var len__25909__auto___33249 = arguments.length;
var i__25910__auto___33250 = (0);
while(true){
if((i__25910__auto___33250 < len__25909__auto___33249)){
args33245.push((arguments[i__25910__auto___33250]));

var G__33251 = (i__25910__auto___33250 + (1));
i__25910__auto___33250 = G__33251;
continue;
} else {
}
break;
...
var G__33248 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33248,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33248;
}
});
...
var len__25909__auto___33256 = arguments.length;
var i__25910__auto___33257 = (0);
while(true){
if((i__25910__auto___33257 < len__25909__auto___33256)){
args__25916__auto__.push((arguments[i__25910__auto___33257]));

var G__33258 = (i__25910__auto___33257 + (1));
i__25910__auto___33257 = G__33258;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33253){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33254,G__33255,seq33253__$2);
});
...
var file = cljs.core.get.call(null,map__33262__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33262__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33262__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33262,map__33262__$1,file,line,column){
return (function (p1__33259_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33259_SHARP_));
});})(map__33262,map__33262__$1,file,line,column))
...
var temp__4657__auto___33264 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33264)){
var message_33265 = temp__4657__auto___33264;
cljs.core.println.call(null,message_33265);
} else {
}
...
var G__33277 = exception.stack;
var G__33277__$1 = (((G__33277 == null))?null:clojure.string.split_lines.call(null,G__33277));
var G__33277__$2 = (((G__33277__$1 == null))?null:cljs.core.get.call(null,G__33277__$1,depth));
if((G__33277__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33277__$2);
}
} else {
...
var vec__33278 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33278,(0),null);
var column = cljs.core.nth.call(null,vec__33278,(1),null);
var vec__33281 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33281,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33281,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33281,(2),null);
...
var m__$1 = (function (){var G__33285 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__33285) {
case "fail":
...
var G__33291 = (function (){var G__33290 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33290);
} else {
return G__33290;
}
})();
...
return cljs.core.vary_meta.call(null,G__33293,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e33296){var e = e33296;
var G__33297 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__33297) {
...
var vec__33302 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33302,(0),null);
var types = vec__33302;
...
return cljs.core.map.call(null,(function (p__33314){
var vec__33315 = p__33314;
var ns = cljs.core.nth.call(null,vec__33315,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33315,(1),null);
return ((function (vec__33315,ns,vars__$1){
return (function (){
...
var G__33318 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__33318) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1){
return (function (){
var seq__33319 = cljs.core.seq.call(null,vars__$1);
var chunk__33320 = null;
var count__33321 = (0);
var i__33322 = (0);
while(true){
if((i__33322 < count__33321)){
var v = cljs.core._nth.call(null,chunk__33320,i__33322);
var temp__4657__auto___33324 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33324)){
var t_33325 = temp__4657__auto___33324;
each_fixture_fn.call(null,((function (seq__33319,chunk__33320,count__33321,i__33322,t_33325,temp__4657__auto___33324,v,each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33325)));
});})(seq__33319,chunk__33320,count__33321,i__33322,t_33325,temp__4657__auto___33324,v,each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1))
);
} else {
}

var G__33326 = seq__33319;
var G__33327 = chunk__33320;
var G__33328 = count__33321;
var G__33329 = (i__33322 + (1));
seq__33319 = G__33326;
chunk__33320 = G__33327;
count__33321 = G__33328;
i__33322 = G__33329;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__33319);
if(temp__4657__auto__){
var seq__33319__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33319__$1)){
var c__25645__auto__ = cljs.core.chunk_first.call(null,seq__33319__$1);
var G__33330 = cljs.core.chunk_rest.call(null,seq__33319__$1);
var G__33331 = c__25645__auto__;
var G__33332 = cljs.core.count.call(null,c__25645__auto__);
var G__33333 = (0);
seq__33319 = G__33330;
chunk__33320 = G__33331;
count__33321 = G__33332;
i__33322 = G__33333;
continue;
} else {
var v = cljs.core.first.call(null,seq__33319__$1);
var temp__4657__auto___33334__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33334__$1)){
var t_33335 = temp__4657__auto___33334__$1;
each_fixture_fn.call(null,((function (seq__33319,chunk__33320,count__33321,i__33322,t_33335,temp__4657__auto___33334__$1,v,seq__33319__$1,temp__4657__auto__,each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33335)));
});})(seq__33319,chunk__33320,count__33321,i__33322,t_33335,temp__4657__auto___33334__$1,v,seq__33319__$1,temp__4657__auto__,each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1))
);
} else {
}

var G__33336 = cljs.core.next.call(null,seq__33319__$1);
var G__33337 = null;
var G__33338 = (0);
var G__33339 = (0);
seq__33319 = G__33336;
chunk__33320 = G__33337;
count__33321 = G__33338;
i__33322 = G__33339;
continue;
}
} else {
...
});})(each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1))
);
});})(each_fixture_fn,G__33318,env,once_fixtures,each_fixtures,vec__33315,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1513979288225