...
return (new CustomEvent(event_name,(function (){var obj34081 = {"detail":data};
return obj34081;
})()));
} else {
...
var args34086 = [];
var len__25909__auto___34092 = arguments.length;
var i__25910__auto___34093 = (0);
while(true){
if((i__25910__auto___34093 < len__25909__auto___34092)){
args34086.push((arguments[i__25910__auto___34093]));

var G__34094 = (i__25910__auto___34093 + (1));
i__25910__auto___34093 = G__34094;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34086.length)].join('')));
...
var f = (function (){var pred__34089 = cljs.core._EQ_;
var expr__34090 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34089.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34090))){
return ((function (pred__34089,expr__34090){
return (function (p1__34082_SHARP_){
return console.warn(p1__34082_SHARP_);
});
;})(pred__34089,expr__34090))
} else {
if(cljs.core.truth_(pred__34089.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34090))){
return ((function (pred__34089,expr__34090){
return (function (p1__34083_SHARP_){
return console.debug(p1__34083_SHARP_);
});
;})(pred__34089,expr__34090))
} else {
if(cljs.core.truth_(pred__34089.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34090))){
return ((function (pred__34089,expr__34090){
return (function (p1__34084_SHARP_){
return console.error(p1__34084_SHARP_);
});
;})(pred__34089,expr__34090))
} else {
return ((function (pred__34089,expr__34090){
return (function (p1__34085_SHARP_){
return console.log(p1__34085_SHARP_);
});
;})(pred__34089,expr__34090))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34096){
var map__34099 = p__34096;
var map__34099__$1 = ((((!((map__34099 == null)))?((((map__34099.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34099.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34099):map__34099);
var opts = map__34099__$1;
var eval_fn = cljs.core.get.call(null,map__34099__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34101_SHARP_);
});})(new_def))
);
...
return (function (p__34102){
var vec__34103 = p__34102;
var ky = cljs.core.nth.call(null,vec__34103,(0),null);
var v = cljs.core.nth.call(null,vec__34103,(1),null);
...
var args34106 = [];
var len__25909__auto___34109 = arguments.length;
var i__25910__auto___34110 = (0);
while(true){
if((i__25910__auto___34110 < len__25909__auto___34109)){
args34106.push((arguments[i__25910__auto___34110]));

var G__34111 = (i__25910__auto___34110 + (1));
i__25910__auto___34110 = G__34111;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1513979289376